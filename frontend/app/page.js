...
export default function Page() {
  ...
  const [apiBase, setApiBase] = useState(process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8081')
  ...
  return (
    <div style={{ maxWidth: 400, margin: '2rem auto', padding: 16, fontFamily: 'system-ui' }}>
      <h1>Greet (Next.js + Go)</h1>
      <p>Next.js frontend + Go API — one repo.</p>
      <form onSubmit={handleSubmit}>
        ...
        <label style={{ display: 'block', marginBottom: 8 }}>API URL</label>
